...
import phoneAccessoriesDeals from "../data/phoneAccessoriesDeals";
...
const PhoneAccessoriesDeals = () => {
  ...
  const next = () => {
    if (startIndex + ITEMS_PER_VIEW < phoneAccessoriesDeals.length) {
  ...
  const visibleItems = phoneAccessoriesDeals.slice(
    startIndex,
