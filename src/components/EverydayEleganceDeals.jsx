...
import everydayEleganceDeals from "../data/everydayEleganceDeals";
...
const EverydayEleganceDeals = () => {
  ...
  const next = () => {
    if (startIndex + ITEMS_PER_PAGE < everydayEleganceDeals.length) {
  ...
  const visibleItems = everydayEleganceDeals.slice(
    startIndex,
