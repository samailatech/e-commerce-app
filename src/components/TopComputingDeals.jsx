...
import topComputingDeals from "../data/topComputingDeals";

const ITEMS_PER_VIEW = 6;

const TopComputingDeals = () => {
  const [startIndex, setStartIndex] = useState(0);

  const next = () => {
    if (startIndex + ITEMS_PER_VIEW < topComputingDeals.length) {
  ...
  const visibleDeals = topComputingDeals.slice(
    startIndex,
...
export default TopComputingDeals;