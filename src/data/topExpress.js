...
import holidayMustHave from "../data/holidayMustHave";
...
const HolidayMustHave = () => {
  ...
  const next = () => {
    if (startIndex + ITEMS_PER_VIEW < holidayMustHave.length) {
  ...
  const visibleItems = holidayMustHave.slice(
    startIndex,
    ...
    <div className="container my-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h5 className="fw-bold mb-0">
          Holiday Must Have | <span className="text-danger">Holiday Sales</span>
        </h5>
